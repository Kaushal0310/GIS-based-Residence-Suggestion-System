...
lyr_NYA_IntLHSSS_5.set('fieldAliases', {'GID': 'GID', 'STREET NAM': 'STREET NAM', 'ZIP CODE': 'ZIP CODE', 'LIBRARAY': 'LIBRARAY', 'L_Address': 'L_Address', 'HOSPITAL': 'HOSPITAL', 'H_Adress': 'H_Adress', 'SCHOOL': 'SCHOOL', 'S_Adress': 'S_Adress', 'STOP_ID': 'STOP_ID', 'SubwayStat': 'SubwayStat', });
...
lyr_SubwayStation_4.set('fieldImages', {'GID': 'TextEdit', 'Stop_ID': 'TextEdit', 'Stop_Name': 'TextEdit', 'Trains': 'TextEdit', 'complex_id': 'TextEdit', 'multi_st': 'TextEdit', 'stop_id2': 'TextEdit', 'bcode': 'TextEdit', 'stop_lat': 'TextEdit', 'stop_lon': 'TextEdit', });
lyr_NYA_IntLHSSS_5.set('fieldImages', {'GID': '', 'STREET NAM': '', 'ZIP CODE': '', 'LIBRARAY': '', 'L_Address': '', 'HOSPITAL': '', 'H_Adress': '', 'SCHOOL': '', 'S_Adress': '', 'STOP_ID': '', 'SubwayStat': '', });
...
lyr_NYA_IntLHSSS_5.set('fieldLabels', {'GID': 'inline label', 'STREET NAM': 'no label', 'ZIP CODE': 'inline label', 'LIBRARAY': 'inline label', 'L_Address': 'inline label', 'HOSPITAL': 'inline label', 'H_Adress': 'inline label', 'SCHOOL': 'inline label', 'S_Adress': 'inline label', 'STOP_ID': 'inline label', 'SubwayStat': 'no label', });
